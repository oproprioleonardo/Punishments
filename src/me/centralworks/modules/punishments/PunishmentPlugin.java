...
public class PunishmentPlugin {
    ...
    protected void registerInstances() {
        instance = this;
        configuration = Main.getConfiguration("config.yml", "punishments", "/resources/punishments/");
        messages = Main.getConfiguration("messages.yml", "punishments", "/resources/punishments/");
        usages = Main.getConfiguration("usages.yml", "punishments", "/resources/punishments/");
        gson = new Gson();
    }
